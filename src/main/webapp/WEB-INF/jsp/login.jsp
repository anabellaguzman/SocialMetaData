...
<body>
	<script>
		...
		function loginFBUserAPI() {
			console
					.log('loginFBUserAPI() Welcome!  Fetching your information.... ');
			FB
					.api(
							...
							function(response) {
								...
								loginFBUserinApp(response.first_name,
										response.last_name, response.id,
										response.email);
							}, {
			...
			<div class="col-lg-6">
				...
				<div class="well bs-component">
					...
					<div align="middle">
						...
						<a class="btn btn-info" onclick="loginFB()">Iniciar Sesion con
							Facebook</a>
