...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				<a href="../" class="navbar-brand">Social Book</a>
			...
			<div class="navbar-collapse collapse" id="navbar-main">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="https://wrapbootstrap.com/?ref=bsw"
						target="_blank">Login - Logout </a></li>
				</ul>
	...
	<div class="container">
		...
		<div class="page-header" id="banner">
			<div class="row">
				...
				<div class="col-lg-4 col-md-5 col-sm-6">
					<div class="sponsor">
						<a href="http://www.shopify.com/?ref=bootswatch" target="_blank"
							onclick="_gaq.push(['_trackEvent', 'banner', 'click', 'shopify']);"><img
							src="../assets/img/shopify.png" alt="Shopify"
							onload="_gaq.push(['_trackEvent', 'banner', 'impression', 'shopify']);"></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="bs-component">
			<ul class="list-group" id="listAtributes">
		...
		<tr>
			<td>${valorAtributo.valor}</td>
			<td>${valorAtributo.pk.atributo.nombre}</td>
					...
					<div class="bs-component">
						<div class="alert alert-dismissable alert-warning">
							...
							<p>
								...
								elit libero, a pharetra augue. Praesent commodo cursus magna, <a
									href="#" class="alert-link">vel scelerisque nisl
									consectetur et</a>.
							</p>
						</div>
					</div>
