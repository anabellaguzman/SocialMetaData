          ...
          <div class="col-lg-4 col-md-5 col-sm-6">
            <div class="sponsor">
              <a href="http://www.shopify.com/?ref=bootswatch" target="_blank" onclick="_gaq.push(['_trackEvent', 'banner', 'click', 'shopify']);">
                <img src="<c:url value="/resources/images/1.jpg" />" alt="Shopify" width="180" height="150" onload="_gaq.push(['_trackEvent', 'banner', 'impression', 'shopify']);">
              </a>
            </div>
          </div>
        </div>
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>Made by <a href="http://thomaspark.co" rel="nofollow">Thomas Park</a>. Contact him at <a href="/cdn-cgi/l/email-protection#d1a5b9bebcb0a291b3bebea5a2a6b0a5b2b9ffb2bebc"><span class="__cf_email__" data-cfemail="e99d818684889aa98b86869d9a9e889d8a81c78a8684">[email&#160;protected]</span><script cf-hash='f9e31' type="text/javascript">
...
<!--     <script src="../resources/flatly/bootstrap.min.js"></script> -->   
